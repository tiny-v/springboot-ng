        ...
        link: function(scope, element, attrs) {
          ...
          if (scope.treeControl != null) {
            if (angular.isObject(scope.treeControl)) {
              ...
              //获取某个特定的节点
               tree.get_test_branch = function(branch) {
               	  var a = scope.treeData[0].children;
                   return a[branch.parentId];
              };
              //选中某个特定的节点
              tree.select_test_branch = function(branch) {
                var c;
                c = tree.get_test_branch(branch);
                return tree.select_branch(c);
              };
