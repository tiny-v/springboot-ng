app.controller('ossCtrl',['$scope','$upload','ossService',function($scope,$upload,ossService){

	$scope.file = [];
	console.log('this is oss ctrl');
	...
	$scope.upload = function(){
		...
		}).success(function(data) {        // file is uploaded successfully
			console.log(data);
		});	
