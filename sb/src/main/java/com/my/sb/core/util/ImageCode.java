...
public class ImageCode{
	...
	public static Map execute(HttpServletRequest servletRequest,HttpServletResponse servletResponse) throws Exception {
        int width = 120;
        int height = 30;
        ...
        try { 
            ...
            byte[] data = ImgResizeUtils.resize(is,96);
            String imgData = "data:image/jpeg;base64," + Image2Base64.transfer(data);
            map.put("imgData", imgData);
            map.put("imgCode", sb.toString());
        } catch (IOException e) { 
            e.printStackTrace(); 
        }  
        return map;
